...
<body class="font-Manrope text-p">
    ...
    <header id="site-header">
                ...
                <div class="col-span-6 xl:col-span-8">
                    <ul class="flex xl:justify-end h-full">
                        ...
                        <li class="flex flex-1 xl:hidden">
                            <a class="w-full justify-center uppercase bg-brand-darkgrey text-white flex items-center hover:brightness-110 transition-all duration-500 font-bold" href="#" title="Book a survey" aria-label="Book a survey">
                ...
                <div class="grid grid-cols-12">
                    <nav class="col-span-12">
                        <ul class="flex flex-row justify-center items-center gap-4">
                            <li class="inline">
                                <a href="#" title="Roof Replacements" aria-label="Roof Replacements" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Roof Replacements
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Conservatories" aria-label="Conservatories" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Conservatories
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Orangeries" aria-label="Orangeries" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Orangeries
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Windows" aria-label="Windows" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Windows
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Doors" aria-label="Doors" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Doors
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Garden Studios" aria-label="Garden Studios" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Garden Studios
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Showrooms" aria-label="Showrooms" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Showrooms
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Finance Options" aria-label="Finance Options" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Finance Options
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="Inspiration" aria-label="Inspiration" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    Inspiration
                                </a>
                            </li>
                            <li class="inline">
                                <a href="#" title="About" aria-label="About" class="p-4 inline-block hover:text-brand-orange transition-all duration-300 font-bold">
                                    About
                                </a>
                            </li>
                        </ul>
        ...
        <div class="bg-brand-orange">
            <div class="scroll">
                <div class="uppercase text-brand-darkgrey text-scrolling-sm lg:text-scrolling-lg animation">
                    <p class="py-2 font-bold">Up to 60% off the entire solarframe range - interest free credit available - transform your home in time for summer - up to 60% off the entire solarframe range - interest free credit available - transform your home in time for summer - </p>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="container">
                <div class="grid grid-cols-12 gap-8">
                    <div class="col-span-12 lg:col-span-5 lg:col-start-2">
                        <h1 id="main-title" class="text-h1 lg:text-lg-h1 font-bold text-brand-darkgrey">Welcome To SolarFrame, your local Yorkshire experts in all things home improvement!</h1>
                    </div>
            ...
            <div class="2xlx:container">
                <div class="grid grid-cols-3 xl:grid-rows-3">
                    <div class="col-span-3 xl:col-span-1 lg:row-span-3 bg-brand-orange p-10 flex flex-col justify-center gap-4 border border-brand-white">
                        <h2 class="text-h2 text-brand-white font-bold">Our brand new showroom at Kirkstall Bridge Shopping Park in Leeds is now open!</h2>
                        ...
                        <div class="xl:w-2/3 flex flex-col gap-4">
                            <a href="#" title="Explore our new leeds showroom" aria-label="Explore our new leeds showroom" class="bg-brand-white text-brand-darkgrey text-center uppercase py-4 px-8 block hover:brightness-110 transition-all duration-300 font-bold">Explore our new Leeds showroom</a>
                            <a href="#" title="Explore our south yorkshire showroom" aria-label="Explore our south yorkshire showroom" class="bg-brand-darkgrey text-brand-white uppercase text-center py-4 px-8 block hover:brightness-110 transition-all duration-300 font-bold">Explore our south yorkshire showroom</a>
                        </div>
                    </div>
                    ...
                    <div class="col-span-3 xl:col-span-2 xl:row-span-1 border border-brand-white relative min-h-[300px]">
                        ...
                        <div class="absolute inset-0 h-full w-full lg:w-1/3 flex flex-col p-8 gap-4 justify-center text-brand-white text-p">
                            <h3 class="text-h3 font-bold">Solar PV Now Available!</h3>
                            <p>Take control of your energy bills with Solar PV and Battery Storage!</p>
                            <a href="/" title="Find out more" aria-label="Find out more" class="text-brand-orange self-start hover:text-brand-black transition-all duration-300 font-bold">Find out more</a>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-3">
                    <div class="col-span-3 lg:col-span-1 border border-brand-white overflow-hidden">
                ...
                <div class="grid grid-cols-4 lg:grid-rows-2">
                    <div class="col-span-4 lg:col-span-2 lg:row-span-2 border border-brand-white overflow-hidden">
                        <a href="#" title="Roof Replacements" aria-label="Roof Replacements" class="relative group">
                            ...
                            <div class="absolute bottom-0 p-4 text-brand-white">
                                <h3 class="text-h3 mb-4 font-bold">Roof Replacements</h3>
                                <p></p>
                                <div class="flex">
                                    <i class="fa fa-long-arrow-right h-[35px] w-[35px] border border-brand-orange rounded-full !flex items-center justify-center mr-2 group-hover:bg-brand-orange transition-all duration-300" aria-hidden="true"></i>
                                    <p class="flex items-center">More information</p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide relative overflow-hidden group">
                                <a href="#" title="Case Study 1" aria-label="Case Study 1">
                                    ...
                                    <div class="absolute bottom-0 text-brand-white p-4">
                                        <h3 class="text-p mb-4 lg:text-lg-h3 font-bold">"After the transformation the conservatory definitely retains its heat better"</h3>
                                        <p></p>
                                        <div class="flex">
                                            <i class="fa fa-long-arrow-right h-[35px] w-[35px] border border-brand-orange rounded-full !flex items-center justify-center mr-2 group-hover:bg-brand-orange transition-all duration-300" aria-hidden="true"></i>
                            ...
                            <div class="swiper-slide relative overflow-hidden group">
                                <a href="#" title="Case Study 2" aria-label="Case Study 2">
                                    ...
                                    <div class="absolute bottom-0 text-brand-white p-4">
                                        <h3 class="text-p mb-4 lg:text-lg-h3 font-bold">"We are not quite into summer yet but the temperature difference is unbelievable"</h3>
                                        <p></p>
                                        <div class="flex">
                                            <i class="fa fa-long-arrow-right h-[35px] w-[35px] border border-brand-orange rounded-full !flex items-center justify-center mr-2 group-hover:bg-brand-orange transition-all duration-300" aria-hidden="true"></i>
                                            <p class="flex items-center">View case study</p>
                            ...
                            <div class="swiper-slide relative overflow-hidden group">
                                <a href="#" title="Case Study 3" aria-label="Case Study 3">
                                    ...
                                    <div class="absolute bottom-0 text-brand-white p-4">
                                        <h3 class="text-p mb-4 lg:text-lg-h3 font-bold">"The conservatory roof replacement has really changed the way that we use the space!"</h3>
                                        <p></p>
                                        <div class="flex">
                                            <i class="fa fa-long-arrow-right h-[35px] w-[35px] border border-brand-orange rounded-full !flex items-center justify-center mr-2 group-hover:bg-brand-orange transition-all duration-300" aria-hidden="true"></i>
                                            <p class="flex items-center">View case study</p>
        ...
        <div class="container px-4 py-10">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 lg:col-span-9">
                    <p class="text-footer-sm-p">&copy; SolarFrame 2023, Company Registration No. 06990167 - Registered in England & Wales.</p>
                </div>
                <div class="col-span-12 lg:col-span-3 lg:text-right">
                    <a href="#" title="website by bluestorm" aria-label="website by bluestorm" class="inline text-footer-sm-p">Website designed by <img src="images/bluestorm.svg" alt="bluestorm logo" class="inline"></a>
                </div>
            </div>
        </div>
    ...
    <section id="brochure-popup" class="hidden fixed bottom-0 left-0 right-0 z-[1001]">
        <div class="bg-brand-darkgrey py-10 w-full overflow-y-auto overflow-x-hidden max-h-[500px]">
            <div class="container">
                <div class="grid grid-cols-12">
