...
<body class="font-Manrope text-p">
    ...
    <main id="content" role="main">
                ...
                <div class="grid grid-cols-3">
                    ...
                    <div class="col-span-3 lg:col-span-1 border border-brand-white overflow-hidden">
                        <a href="#" title="Extensions" aria-label="Extensions" class="relative group">
                            ...
                            <div class="absolute bottom-0 p-4 text-brand-white">
                                <h3 class="text-h3 mb-4">Single Story Extensions</h3>
        ...
        <section id="testimonials" class="mb-10">
            <div class="container">
                <div class="grid grid-cols-12">
                    <div class="col-span-10 col-start-2 flex justify-between">
                        <div>
                        ...
                        <div class="flex gap-1">
                            <div class="testimonial-button-prev h-[50px] w-[50px] bg-brand-orange text-brand-white flex justify-center items-center"><i class="fa fa-arrow-left" aria-hidden="true"></i></div>
                            <div class="testimonial-button-next h-[50px] w-[50px] bg-brand-orange text-brand-white flex justify-center items-center"><i class="fa fa-arrow-right" aria-hidden="true"></i></div>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-12">
