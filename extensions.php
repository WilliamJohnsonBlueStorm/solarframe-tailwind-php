<?php
$breadcrumbs = ['Home', 'Conservatories'];
$pageTitle = 'Single-Storey Extensions';
?>
...
<?php include ('components/department-banner.php') ?>
    ...
    <main id="content" role="main">
        ...
        <?php include ('components/department-intro.php') ?>

        <?php include ('components/why-choose-solid-roof-extension.php') ?>

        <?php include ('components/extension-style.php') ?>
